...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Add Category Details</h3>
        </div>
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="container">
                    ...
                    <form method="POST" action="../actions/category.php">
                        ...
                        <input type="text" id="c_name" name="c_name" class="form-input" required>
                        <input type="submit" name="add" value="Add category" class="submit-btn">
                    </form>
                </div>
            </div>
        </div>
...
<!-- Display the added categorys in a table -->
            ...
            <div class="card-body">
                ...
                <div class="table-striped table-bordered table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            <?php
                            // Fetch all categorys from MongoDB collection
